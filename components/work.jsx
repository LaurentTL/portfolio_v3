...
export const WorkRight = ({ children, progress }) => {
    ...
    return (
        <div className="flex flex-1 lg:items-center justify-center h-screen" style={{
            ...
            <div className="w-full max-w-md pt-10 lg:pt-0 px-10 md:px-10">
                {children}
            </div>
        </div>
    )
...
export const WorkLink = ({ href, children }) => (
    <Link href={href}><a target="_blank" rel='noreferr ' className='underline underline-offset-8 decoration-1'>{children}</a></Link>
)
